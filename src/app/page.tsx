        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            >
              <div className="w-12 h-12 bg-black rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6 fill-white" viewBox="0 0 24 24">
                  <path d="M3.2 3.2c2.8 1.8 7.2 5.8 8.8 8.8 1.6-3 6-7 8.8-8.8-2.8 1.8-7.2 5.8-8.8 8.8-1.6-3-6-7-8.8-8.8zm8.8 8.8c1.6 3 6 7 8.8 8.8-2.8-1.8-7.2-5.8-8.8-8.8-1.6 3-6 7-8.8 8.8 2.8-1.8 7.2-5.8 8.8-8.8z"/>
                </svg>
              </div>
      ...
      <footer className="py-12 bg-[#3A3A3A] text-[#FAF9F7]">
        ...
        <div className="flex gap-4">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <a href="/terms" className="block opacity-80 hover:opacity-100">Terms of Service</a>
                <a href="/privacy" className="block opacity-80 hover:opacity-100">Privacy Policy</a>
